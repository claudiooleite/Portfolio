  ...
  return (
    <FullScreenSection>
      ...
      <Text>
        ...
        user-friendly web applications. I started my coding journey seven months
        ago with the Odin Project's Foundations course. This hands-on program
        taught me the basics of HTML, CSS, and JavaScript, supported by a great
        community.
      </Text>
      ...
      <Text mt={4}>
        ...
        became proficient in React, state management, and responsive design. One
        of my favourite projects was building the Little Lemon Restaurant Web
        App, which tested and showcased my abilities. You can see this and other
        projects on my profile.
      </Text>

      <Heading as="h3" size="lg" mt={8} mb={4}>
        After working in sports and fitness for ten years, I'm excited to bring
        my skills to front-end development:
      </Heading>
      <Flex as="ul" mt={2} direction="column">
        ...
        <Box as="li">
          <Text>
            <strong>Attention to Detail:</strong> Making precise training plans
            helps me write clean and accurate code.
          </Text>
        </Box>
        <Box as="li">
          <Text>
        ...
        <Box as="li">
          <Text>
            <strong>Team Collaboration:</strong> Leading and working with sports
            teams helps me collaborate effectively with development teams.
          </Text>
        </Box>
        <Box as="li">
          <Text>
      ...
      <Text>
        ...
        front-end development skills. I'm especially interested in roles where I
        can create intuitive and accessible user interfaces, work closely with a
        team, and contribute to meaningful projects.
      </Text>
